...
activities = {
    ...
    "Tennis Club": {
        "description": "Learn and practice tennis techniques and compete in tournaments",
    ...
    "Science Club": {
        "description": "Conduct experiments and explore scientific topics through hands-on activities",
